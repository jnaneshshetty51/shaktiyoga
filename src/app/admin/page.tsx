...
import { mockUsers, mockSubscriptions, mockBookings } from "@/utils/adminData";

export default function AdminDashboardPage() {
    // Mock Stats Calculation
    const activeMembers = mockUsers.filter(u => u.status === 'Active').length;
    const trialUsers = mockUsers.filter(u => u.status === 'Trial').length;
    const mrr = mockSubscriptions.reduce((acc, sub) => sub.status === 'Active' ? acc + sub.amount : acc, 0);
        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                    ...
                    <div className="text-3xl font-bold text-primary">{activeMembers}</div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                    ...
                    <div className="text-3xl font-bold text-gray-800">${mrr}</div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                    ...
                    <div className="text-3xl font-bold text-secondary">{trialUsers}</div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                    ...
                    <div className="text-3xl font-bold text-orange-500">{pendingBookings}</div>
